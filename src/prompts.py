...
def build_repair_prompt(
    ...
    return (
        ...
        f"{checklist_block}"
        f"Caption:\n{caption}\n\n"
        "If the caption is faithful and matches the style rules, return it unchanged.\n"
        "If it adds unsupported details, is too long, is too short, or breaks the style rules, rewrite it.\n"
